                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="px-2 py-1 text-xs rounded-full 
                                                @if($sale->sale_type === 'party') bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200
                                                @elseif($sale->sale_type === 'online') bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200
