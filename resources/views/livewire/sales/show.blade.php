                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <div class="flex items-center gap-2">
                            <button onclick="window.print()" class="px-3 py-1 bg-purple-100 dark:bg-purple-800 text-purple-800 dark:text-purple-200 rounded-full text-sm font-medium hover:bg-purple-200 dark:hover:bg-purple-700 transition flex items-center gap-1" title="Print Invoice">
